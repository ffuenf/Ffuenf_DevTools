...
class Ffuenf_DevTools_Test_Block_Urlrewrite_Grid extends EcomDev_PHPUnit_Test_Case_Config
{
    ...
    public function testBlockAliases()
    {
        $this->assertBlockAlias(
            'ffuenf_devtools/urlrewrite_grid',
            'Ffuenf_DevTools_Block_Urlrewrite_Grid'
        );
    }
}
