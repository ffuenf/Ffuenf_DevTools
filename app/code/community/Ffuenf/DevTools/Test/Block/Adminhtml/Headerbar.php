...
class Ffuenf_DevTools_Test_Block_Adminhtml_Headerbar extends EcomDev_PHPUnit_Test_Case_Config
{
    ...
    public function testBlockAliases()
    {
        $this->assertBlockAlias(
            'ffuenf_devtools/adminhtml_headerbar',
            'Ffuenf_DevTools_Block_Adminhtml_Headerbar'
        );
    }
}
